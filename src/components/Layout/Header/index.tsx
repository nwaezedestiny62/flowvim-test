  ...
  return (
    ...
    <div
      ...
      className={`lg:hidden fixed top-0 right-0 h-screen
        w-full sm:w-[50%] bg-dark-blur backdrop-blur-lg shadow-2xl
        p-10 z-[999] transform transition-transform duration-500 ease-in-out
    ...
    >
      ...
      {/* Search */}
      <h3 className="font-chakrapetch pb-3">Discover More</h3>
      <form className="search-box relative flex ">
        <input 
          type="text" 
          placeholder='Search insights, services...' 
          className='ps-3 bg-white h-[45px]' 
          required
        />
      ...
      {/* Contact Info - Flowvim Style */}
      <h3 className="font-chakrapetch pb-3 pt-8">Get In Touch</h3>
      
      <div className="space-y-3">
        <span className="text-pera-light font-chakrapetch">Call Us</span><br/>
        <Link
          href="tel:08061540345"
      ...
      <div className="space-y-3">
        <span className="text-pera-light font-chakrapetch">Email Our Team</span><br/>
        <Link
          href="mailto:samson.okorie@gmail.com"
          className='font-unbounded text-white font-normal'
        >
          samson.okorie@gmail.com
        </Link>
      </div>

      <div className="space-y-3">
        <span className="text-pera-light font-chakrapetch">Our Office</span><br/>
        <Link
          href="/contact"
          className='font-unbounded text-white font-normal'
        >
          33 Unity Crescent, Lagos
        </Link>
      </div>

      {/* Social */}
      <h3 className="font-chakrapetch pb-3 pt-8">Follow Our Journey</h3>
      <div className="social-icons flex gap-3">
        {/* Add actual Flowvim social links when available */}
        ...
        <Link href="#" target="_blank">
          <Icon icon='mdi:linkedin' width="30" height="30" className='text-white p-1 rounded-sm cursor-pointer bg-blue-400 hover:-translate-y-1 transition duration-500' />
        </Link>
      </div>
    </div>
